 ...
 */
package br.com.mystore.order.repository.utils;
 ...
 * @author lucas
 */
public final class JsonFormatter extends AbstractJsonFormatMapper {
    ...
    public JsonFormatter(JsonMapper jsonMapper) {
